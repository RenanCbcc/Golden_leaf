...
class UpdateClientForm(FlaskForm):
    ...
    phone_number = StringField('Número do celular',
                               validators=[DataRequired(message="Cliente precisa ter um número de telefone."), Length(min=11, max=11,message="O número precisa ter exatamente 11 caracteres."), Regexp('^[0-9]*$')])
