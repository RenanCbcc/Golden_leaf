...
from Golden_Leaf.views.client import blueprint_client
from Golden_Leaf.views.client.forms import NewClientForm, SearchClientForm, UpdateClientForm
...
def new_client():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(Client(form.name.data, form.phone_number.data, str(identification)[0:9],
